const GAMES = {
  ...
  oligarch: {
    ...
    version: 'V.1.2.0',
    released: '2026',
    url: 'https://github.com/dmitriromanusha1-sys/zero-to-oligarch/releases/download/v1.2.0/ZeroToOligarch-v1.2.0-win64.zip',
    genre: 'Симулятор',
    tags: ['#simulator', '#economy', '#tycoon', '#release'],
    difficulty: 'Средне',
    downloadOnly: true,
    description: 'Симулятор жизни и бизнес-тайкун: путь от бомжа до олигарха. Работайте по сменам, учитесь, покупайте жильё, инвестируйте. Живая экономика (инфляция, циклы, налоги, региональные цены). Постройте бизнес-империю: портфель компаний, филиалы и франшизы, борьба за долю рынка, поглощения конкурентов (M&A), IPO на бирже, корпоративные технологии (R&D), антимонополия и кризисы, международная экспансия и вертикальная интеграция. 9 районов города — от Трущоб до Высшего света.',
    screenshots: [
