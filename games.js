const GAMES = {
  ...
  oligarch: {
    ...
    difficulty: 'Средне',
    downloadOnly: true,
    description: 'Симулятор жизни: путь от бомжа до олигарха. Работайте, учитесь, покупайте жильё, инвестируйте в бизнес и акции и поднимайтесь по социальной лестнице через 9 районов города — от Трущоб до Высшего света.',
    screenshots: [
