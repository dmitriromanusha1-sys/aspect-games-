const GAMES = {
  ...
  oligarch: {
    ...
    version: 'V.1.0.0',
    released: '2026',
    url: 'https://github.com/dmitriromanusha1-sys/zero-to-oligarch/releases/download/v1.0.0/ZeroToOligarch-v1.0.0-win64.zip',
    genre: 'Симулятор',
    tags: ['#simulator', '#economy', '#release'],
    difficulty: 'Средне',
    downloadOnly: true,
    description: 'Симулятор жизни: путь от бомжа до олигарха. Работайте по сменам, учитесь и сдавайте экзамены, покупайте жильё, спите, инвестируйте в бизнес, банк, акции и кредиты. Времена года с атмосферой, 3 слота сохранений и 4 уровня сложности. 9 районов города — от Трущоб до Высшего света.',
    screenshots: [
